...
if sum of numbers[left] + numbers[right] == target, return
else if sum > target, we do right--, since we want smaller numbers
else if sum < target, we do left++, since we want larger numbers
"""
